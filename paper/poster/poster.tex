	...
	\vspace{-1ex}
		...
		\headerbox{Future Work}{name=nedostatki,column=2,below=coverage}{
			\begin{itemize}
				...
				\item phonology (vowel harmony, desonorisation) with abbreviations\\
		...
		\headerbox{Further information}{name=getting,column=1,below=twol}{
			\begin{itemize}
				...
				more info at: \url{http://wiki.apertium.org/}

				\item Turkic RBMT mailing list (we speak your language!):\\
				{\small \texttt{apertium-turkic@lists.sourceforge.net}} (>25 subscribers)
