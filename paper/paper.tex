...
Normal tokenisation often takes white space to be the delimiter between ``words''.  For analysis and generation, however, there are some morphophonological processes that work across the ``whitespace'' boundary.
