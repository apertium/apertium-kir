...
\begin{table*}
	...
	\begin{tabular}{lr}
		...
		\bottomrule
	\end{tabular}
	\caption{Breakdown of number of stems in the lexicon by major part of speech. Minor categories, such as partice, modal and copula are left out.}\label{table:stems}
